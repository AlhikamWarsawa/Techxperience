    ...
    <SafeAreaView style={tw`p-4 bg-[#1e1e1e] flex-1`}>
      <ScrollView>
        <View style={tw`p-2`}>
          ...
          <View style={tw`p-2`}>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              {[
                ...
                <View
                  key={index}
                  style={tw`mr-4 bg-neutral-800 px-4 py-2 rounded-1 border border-white mt-4 mb-4`}
                >
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              <View style={tw`flex-row gap-4`}>
                <Card
                  img={require("@/assets/images/techxperience.png")}
                  title="Free WPU Course"
          ...
          <View style={tw`flex-1 bg-black mb-20`}>
            <View
              style={tw`bg-[#000] flex-row items-center justify-between p-4`}
            >
