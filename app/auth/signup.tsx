    ...
    return (
        <SafeAreaView style={tw`p-4 bg-[#1e1e1e] h-full w-full`}>
            <View style={tw`p-4 bg-[#1e1e1e] h-full w-full mt-15`}>
                ...
                <View style={tw`my-6`}>
                    <ButtonPrimary title='Masuk' warnaBtn='[#4285f4]' route={() => navigation.push('/auth/survey')} warnaText='[#fff]'/>
                </View>
                <View style={tw`mb-6 flex-row justify-center`}>
                    <Text style={tw`text-white`}>Lah Punya Akun?</Text><Text style={tw`text-[#4285f4]`}> Masuk Aja!</Text>
                </View>
